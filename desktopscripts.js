...
map.touchZoomRotate.disable();
        map.getCanvas().style.cursor = 'default';
        map.fitBounds([
[19.13661, 47.38098], // Southwest coordinates
...
[19.37812, 47.47354] // Northeast coordinates // northeastern corner of the bounds
        ...
        var map = new mapboxgl.Map({
            ...
            center: [19.26445, 47.42562], //Lng, Lat
     zoom:11.95,
     minZoom:10,
...
map.touchZoomRotate.disable();
    ...
    offset: [0, -5]
     ...
     zoom:11.95,
            ...
            'ch3v': {
                pitch: 0,
                 center: [19.20812, 47.44868], //Lng, Lat
     zoom:13.10,
                bearing: 0,
            },
            'ch4': {
...
map.touchZoomRotate.disable();
        map.getCanvas().style.cursor = 'default';
        map.fitBounds([
[19.15110, 47.42793], // Southwest coordinates
[19.26554, 47.47003] // Northeast coordinates // northeastern corner of the bounds
]);
